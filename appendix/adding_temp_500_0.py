...
if __name__ == '__main__':
	...
	bf_df = pd.read_csv('houfin_data/houfin_cities_0.csv')

	counter = 0
	
	# Make sure the license number is correct
	str1 = 'http://api.wunderground.com/api/753a4a7523f842e3/history_'
	...
	bf_df.to_csv('houfin_data/houfin_climate_0.csv', sep=',')
